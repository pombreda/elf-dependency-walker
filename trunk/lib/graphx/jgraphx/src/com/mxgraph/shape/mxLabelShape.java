...
public class mxLabelShape extends mxImageShape
{
			...
			mxCellState state)
	{
		...
		path.moveTo((float) state.getX(), (float) state.getY() - 1);
		path.lineTo((float) state.getX(),
				(float) (state.getY() + state.getHeight() * size));
		path.quadTo((float) (state.getX() + state.getWidth() * 0.5),
				(float) (state.getY() + state.getHeight() * 0.7),
				(float) (state.getX() + state.getWidth() + 1),
				(float) (state.getY() + state.getHeight() * size));
		path.lineTo((float) (state.getX() + state.getWidth()),
				(float) state.getY() - 1);
		path.closePath();
